...
const LoginPage = () => {
    ...
    const handlegoogleLogin = async () => {
        ...
        if (error) console.error("Failed to log in through google, message", error)
    }
        ...
        <div className="w-full max-w-md">
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.6)]">
            ...
            <div className="relative p-6 sm:p-8">
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-white">Log In</h1>
              <p className="mt-1 text-white/70 text-sm">Welcome back. Enter your credentials.</p>
